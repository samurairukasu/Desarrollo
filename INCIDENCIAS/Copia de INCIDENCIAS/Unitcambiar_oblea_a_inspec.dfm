object cambiar_oblea_a_inspec: Tcambiar_oblea_a_inspec
  Left = 477
  Top = 245
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cambiar N'#250'mero de Oblea a Inspecci'#243'n'
  ClientHeight = 212
  ClientWidth = 300
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    Width = 265
    Height = 73
    Caption = 'Ingresar N'#250'mero de Oblea'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
