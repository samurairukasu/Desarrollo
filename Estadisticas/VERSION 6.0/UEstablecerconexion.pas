...
begin
    ...
    showmessage('Conexión establecida  a chile correcta !!!');
    close;
    end
    else
    begin
     ...
     label1.Visible:=falsE;
      ...
      showmessage('No se puede establecer la conexión a Chile. Por favor verifique el Cliente VPN de Conexión a Chile.');
