{ :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  ...
  :: 3.6.2 / 3.5                                             ::
  :: LLION PDF methods added 23/09/02                        ::
  :: LLION composite methods added 8-09-02                   ::
  ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: }
...
uses Windows, Classes, Controls, StdCtrls, Sysutils, Graphics, Buttons,
  Forms, ExtCtrls, Dialogs, Printers, DB, DBTables, QRPrntr,
  QR3Const, QRPrgres, QRExpr, QRExpbld{$ifdef LLIONPDF},PDF{$endif};
...
begin
  // this will cause the printer's devmode to be interrgated
...
function ColorStr(Color : TColor) : string;
begin
  if color < 0 then
  begin
     result := '000000';
...
procedure getfontp( var fws, fdecos : string; afont : TFont );
begin
    fws := 'normal';
    fdecos := 'none';
...
function EntityReplace( pctext : string ) : string;
var
    ctext : string;
begin
     ctext := pctext;
