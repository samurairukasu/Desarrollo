...
interface
    ...
    type
        ...
        tTipoDominio = (ttdmAntiguo, ttdmAutos, ttdmMotos, ttdmTractor, ttdmVacio,  ttdmNull, ttdmSpanish);    //mb
        {$IFNDEF INTEVE}
...
//      TTIPOSIVA : array [0..3] of char = ('I', 'N', 'C', 'E');  MODIF RAN
       ...
       ((FALSE, TRUE, TRUE, TRUE), (FALSE, FALSE, FALSE, FALSE),
        ...
        TABLA_COMBINACIONES_OK : array [ttdmAntiguo..ttdmVacio, ttdmAntiguo..ttdmVacio] of boolean=
          ((FALSE, TRUE, TRUE, TRUE, TRUE), (FALSE, FALSE, FALSE, FALSE, FALSE),(FALSE, FALSE, FALSE, FALSE, FALSE), (FALSE, TRUE, TRUE, TRUE, FALSE),(FALSE, TRUE, TRUE, TRUE, FALSE));
