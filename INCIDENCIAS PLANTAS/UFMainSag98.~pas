...
interface
    ...
    uses
        ...
        DBCtrls, Mask, RxLookup, USagCtte,
    ...
    N4: TMenuItem;
    CambiaodePatentes1: TMenuItem;
    N21: TMenuItem;
    CambiarDNIdeClientes1: TMenuItem;
    N22: TMenuItem;
    CambiodeClienteaInspeccin1: TMenuItem;
    ...
    procedure CambiaodePatentes1Click(Sender: TObject);
    procedure CambiarDNIdeClientes1Click(Sender: TObject);
    procedure CambiodeClienteaInspeccin1Click(Sender: TObject);
...
{$R *.DFM}
    uses
        ...
        Ulistadocierrez,
 ufInformeRevesExternasToPrint,UFRESULTADINSPECTIEMPOS,
  Unitrestaura_obleas, Unit1cambiar_oblea_a_inspec,
  Unitcambio_de_pantentes, Unitcambio_de_dni,
  Uncambiar_cliente_a_inspeccion;
...
If bActivandose then
  ...
  Top := -7000;
  if (FindWindow(Pchar('TFInicioAplicacion'), PChar('Delphi 7')) <> 0) or (FindWindow(Pchar('TFMainSag98'), PChar('Incidencias - Planta Verificadora de Vehículos')) <> 0)
  or (FindWindow(Pchar('TFMainSag98'), PChar('Incidencias - Planta Verificadora de Vehículos')) <> 0) then //Lucho
  InitError('Ya existe una copia del programa en ejecución')
    ...
    Caption := 'Incidencias - Planta Verificadora de Vehículos';
...
aServicio := (Sender as TComponent).Tag;
  ...
  restaura_obleas.Edit1.Clear;
  restaura_obleas.showmodal;
end;
...
procedure TFMainSag98.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TFMainSag98.N17Click(Sender: TObject);
begin
...
procedure TFMainSag98.CambiaodePatentes1Click(Sender: TObject);
begin
cambio_de_pantentes.Edit1.Clear;
cambio_de_pantentes.Edit2.Clear;
cambio_de_pantentes.Edit3.Clear;

cambio_de_pantentes.showmodal;
end;

procedure TFMainSag98.CambiarDNIdeClientes1Click(Sender: TObject);
begin
cambio_de_dni.Edit1.Clear;
cambio_de_dni.Edit2.Clear;
cambio_de_dni.showmodal;
end;

procedure TFMainSag98.CambiodeClienteaInspeccin1Click(Sender: TObject);
begin
cambiar_cliente_a_inspeccion.Edit1.Clear;
cambiar_cliente_a_inspeccion.Edit2.Clear;
