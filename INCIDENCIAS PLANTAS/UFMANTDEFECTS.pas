...
var
   frmMantenimientoDefectos: TfrmMantenimientoDefectos;
    ...
    try
       try
          ...
          begin
              ...
              Sql.Clear;
              SQLConnection := MyBD;
              Sql.Add ('SELECT CODDEFEC,LITDEFEC,ACTIVO FROM TDEFECTOS WHERE CODCAPIT=:CodigoCap AND CODAPART=:CodigoApa AND ABRDEFEC=:AbrDef');
              Params[0].AsInteger := CodigoCap;
    ...
    try
       try
          ...
          begin
              ...
              SQLConnection := MyBD;
              Sql.Clear;
              Sql.Add ('SELECT ABRDEFEC,LITDEFEC,ACTIVO FROM TDEFECTOS WHERE CODCAPIT=:CodigoCap AND CODAPART=:CodApa AND CODDEFEC=:CodDef');
              Params[0].AsInteger := CodigoCap;
              Params[1].AsInteger := CodigoApa;
              ...
              begin
                  ...
                  begin}
                      ...
                      begin
                          ...
                          Sql.Add ('(NUMDEFEC,CODCAPIT,CODAPART,CODDEFEC,FECHALTA,CADDEFEC,ACTIVO,ABRDEFEC,LITDEFEC) VALUES');
                          Sql.Add ('(:UltimoNumDef,:ValDefecto.CodigoCapitulo,:ValDefecto.CodigoApartado,:NumDefs,:FechaAlta,:CadenaDefecto,:ValDefecto.DefectoActivo,:ValDefecto.AbreviaturaDefecto,:ValDefecto.LiteralDefecto)');
  ...
  qryConsultas :=TClientDataSet.Create(Self);
    try
       ...
       try
         ...
         begin
             SetProvider(dspConsultas);
             CommandText := 'SELECT ABRDEFEC FROM TDEFECTOS WHERE CODCAPIT=:CodCap AND CODAPART=:CodApa';
    ...
    try
       try
          ...
          begin
              ...
              Sql.Add ('  WHERE CODCAPIT=:Valores.CodigoCapitulo AND CODAPART=:Valores.CodigoApartado');
