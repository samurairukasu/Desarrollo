    ...
    try
     ...
     try
       ...
       then
          ...
          tipover:='V';
       texto:='Nro: '+tipover+Trim(Copy(finspeccion.ValueByName[FIELD_EJERCICI],3,2))+'000'+fvarios.ValueByName[FIELD_ZONA]+'000'+fvarios.ValueByName[FIELD_ESTACION]+formatoceros(strtoint(finspeccion.ValueByName[FIELD_CODINSPE]),6); //AGRE VAZ
       impfis.SendNoFiscalText(texto);
