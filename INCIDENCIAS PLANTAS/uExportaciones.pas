                 ...
                 begin
                   ...
                   while not EOF do begin
                     writeln(f2,zona:2,estacion:2,fieldbyname(FIELD_FECHALTA).asstring:10,
                          ...
                          fieldbyname(FIELD_EJERCICI).asstring:4,fieldbyname(FIELD_CODINSPE).asstring:6);
                     Next;
                   end;
                 end;
                 CloseFile(f2);
               ...
               try
                 ...
                 while not aQ.EOF do begin
                        writeln(f2,zona:2,estacion:2,aQ.fieldbyname(FIELD_FECHALTA).asstring:10,
                          ...
                          aQ.fieldbyname(FIELD_EJERCICI).asstring:4,aQ.fieldbyname(FIELD_CODINSPE).asstring:6);
                     aQ.Next;
                 end;
                 CloseFile(f2);
                 ComprimirArchivos(8);
