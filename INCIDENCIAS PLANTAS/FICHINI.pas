...
resourcestring
    ...
    NOMBRE_SECCION_CAPITULO = 'HEADING';
...
type
   ...
   tAbrCapitApartDefec = string[15]; { Varchar2(15) }
   tLitCapitApartDefec = string[50]; { Varchar2(50) }
...
var
   ...
   sCodigo_Capitulo, sCodigo_Apartado: string; { Variables auxiliares para
         ...
         try
            ...
            begin
                ...
                if VerEurosystem <>'3.18' then
                  begin
                    ...
                    Cadena_Auxiliar := Cadena_Auxiliar + Devolver_Literal_Capitulo (Datos_Capitulo.LitCapit);
                 ...
                 DefectosINI.WriteString (NOMBRE_SECCION_CAPITULO, sCodigo_Capitulo, Cadena_Auxiliar);
                Next;
            end;
               ...
               begin
                   ...
                   if VerEurosystem <>'3.18' then
                      begin
                        ...
                        Nombre_Seccion := Format ('%s%1.2d', [NOMBRE_SECCION_APARTADO, Datos_Apartado.CodCapit]);
                        sCodigo_Apartado := Format ('%1.2d', [Datos_Apartado.CodApart]);
                      end
                    else
                      begin
                        Cadena_Auxiliar := Devolver_Abreviatura_Apartado (Datos_Apartado.AbrApart);
                        Cadena_Auxiliar := Cadena_Auxiliar + Devolver_Literal_Apartado_318 (Datos_Apartado.LitApart);
                   ...
                   { Aniadimos la nueva entrada al fichero INI de Capítulos, Apartados y Defectos }
                   DefectosINI.WriteString (Nombre_Seccion, sCodigo_Apartado, Cadena_Auxiliar);
            ...
            try
               ...
               begin
                   ...
                   fSql.Add ('  FROM TDEFECTOS WHERE');
                   fSql.Add ('  CODCAPIT<=:ULT_DEFVISUAL AND');
                   fSql.Add ('  CODAPART<=:ULT_DEFVISUAL AND');
                   fSql.Add ('  CODDEFEC<=:ULT_DEFVISUAL');
               ...
               begin
                   ...
                   begin
                       ...
                       if VerEurosystem <>'3.18' then
                          ...
                          Cadena_Auxiliar := Cadena_Auxiliar + Devolver_Literal_Defecto (Datos_Defecto.CodDefec{Datos_Defecto.AbrDefec}, Datos_Defecto.LitDefec);
                          Nombre_Seccion := Format ('%s%1.2d%1.2d', [NOMBRE_SECCION_DEFECTO, Datos_Defecto.CodCapit, Datos_Defecto.CodApart]);
                       ...
                       { Aniadimos la nueva entrada al fichero INI de Capítulos, Apartados y Defectos }
                       DefectosINI.WriteString (Nombre_Seccion, Codigo_Defecto_Formateado, Cadena_Auxiliar);
                   end;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (Datos_Revisor.EsSuper = ES_SUPERUSUARIO)then
              begin
                Cadena_Auxiliar := ';' + Nombre_Seccion;
                WriteLn (Fich_Insp, Cadena_Auxiliar);

                Cadena_Auxiliar := NOMBRE_ENTRADA_NUMSUPERVISOR + '=' + sNumero_Revisor;
                WriteLn (Fich_Insp, Cadena_Auxiliar);

                if VerEurosystem = '3.18' then
                  Begin
                    Cadena_Auxiliar := NOMBRE_ENTRADA_APPSUPERVISOR + '=' + Datos_Revisor.AppRevis;
                    WriteLn (Fich_Insp, Cadena_Auxiliar);

                    Cadena_Auxiliar:= NOMBRE_ENTRADA_PALCLAVESUPERVISOR + '=' +Desencriptar(Datos_Revisor.PalClave,Datos_Revisor.NumRevis);
                    WriteLn (Fich_Insp, Cadena_Auxiliar);

                    Cadena_Auxiliar := NOMBRE_ENTRADA_NOMSUPERVISOR + '=' + Datos_Revisor.NomRevis;
                    WriteLn (Fich_Insp, Cadena_Auxiliar);
                  end
                else
                  Begin
                    Cadena_Auxiliar := NOMBRE_ENTRADA_APPSUPERVISOR + '=' + Datos_Revisor.NomRevis;
                    WriteLn (Fich_Insp, Cadena_Auxiliar);

                    Cadena_Auxiliar := NOMBRE_ENTRADA_PALCLAVESUPERVISOR + '=' + Datos_Revisor.PalClave;
                    WriteLn (Fich_Insp, Cadena_Auxiliar);
                  end;
              end
////////////////////////////////////////////////////////////////////////////////////////////////////
            else  // SI NO ES SUPER USUARIO
              begin
                Cadena_Auxiliar := ';' + Nombre_Seccion;
                WriteLn (Fich_Insp, Cadena_Auxiliar);
                ...
                if VerEurosystem = '3.18' then
                  Begin
                    Cadena_Auxiliar := NOMBRE_ENTRADA_APPREVISOR + '=' + Datos_Revisor.AppRevis;
                    WriteLn (Fich_Insp, Cadena_Auxiliar);

                    Cadena_Auxiliar:= NOMBRE_ENTRADA_PALCLAVE + '=' +Desencriptar(Datos_Revisor.PalClave,Datos_Revisor.NumRevis);
                    WriteLn (Fich_Insp, Cadena_Auxiliar);

                    Cadena_Auxiliar := NOMBRE_ENTRADA_NOMREVISOR + '=' + Datos_Revisor.NomRevis;
                    WriteLn (Fich_Insp, Cadena_Auxiliar);
                  end
                else
                  Begin
                    ...
                    Cadena_Auxiliar := NOMBRE_ENTRADA_PALCLAVE + '=' + Datos_Revisor.PalClave;
                    WriteLn (Fich_Insp, Cadena_Auxiliar);
                  end;
////////////////////////////////////////////////////////////////////////////////////////////////////
              end;
