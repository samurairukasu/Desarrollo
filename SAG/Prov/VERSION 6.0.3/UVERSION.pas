...
interface
    ...
    const
        ...
        ESTADO = '(C) ';
        VERSION_ENTREGA = 2.5;
        VERSION = ' Version: 6.0.2 26/04/2017';
        FECHA_VERSION = '26/04/2017';
       ...
       {$IFDEF SLECTURA}
        ...
        {$IFDEF SAG98}
          NOMBRE_PROYECTO = 'SAG.® 2017 ';
          VERSION = 'Ver 6.0.3';
          VERSION_PROYECTO = '6.0.3';
          ESTADO = ' ';
          VERSION_ENTREGA = 3.00;
          FECHA_VERSION = '12/05/2017';
          LITERAL_VERSION = NOMBRE_PROYECTO + VERSION_PROYECTO + ESTADO + FECHA_VERSION;
          LOGS_KEY = LOGS_+'\APP';
        {$ENDIF}
