...
type
  TFArqueoCajaExtTot = class(TForm)
    ...
    Label10: TLabel;
    Label11: TLabel;
    EdtIIBBvtvCABA: TEdit;
    EdtIIBBgncCABA: TEdit;
    EdtTotalIIBBCABA: TEdit;
  ...
  public
    ...
    TotalCDVTV, TotalCDGNC, TotalIIBBVTV,TotalIIBBVTVCABA, TotalTotalVTV,
    TotalIIBBGNC,TotalIIBBGNCCABA, TotalTotalGNC,
  ...
  procedure DoArqueoCajaTotales(const FI,FF: string;
                         var sTotFactVTV, sTotNCVTV, sTotImpVTV, sTotIVAInsVTV, sTotIVANoInsVTV, sTotCDVTV, sTotIBBVTV,sTotIBBVTVCABA, sTotTotVTV: string; sTipoCliente:string;
                         var sTotFactGNC, sTotNCGNC, sTotImpGNC, sTotIVAInsGNC, sTotIVANoInsGNC, sTotCDGNC, sTotIBBGNC,sTotIBBGNCCABA, sTotTotGNC : string);
...
begin
    ...
    try
        ...
        sTotIBBVTVCABA := floattostrf(strtofloat(ParamByName('IIBBCabaEnCaja').AsString),fffixed,8,2);
...
begin
        ...
        try
            try
                ...
                TotalIIBBVTV := '0'; TotalTotalVTV := '0'; TotalIIBBGNC := '0';TotalIIBBGNCCABA := '0'; TotalTotalGNC := '0';
                ...
                DoArqueoCajaTotales(DateIni, DateFin, NumeroFacturas, NumeroNotasCredito, TotalImporteVTV, TotalIvaVTV, TotalIvaNIVTV, TotalCDVTV,TotalIIBBVTV, TotalIIBBVTVCABA,TotalTotalVTV,'',
                                    NumeroFacturasGNC, NumeroNotasCreditoGNC, TotalImporteGNC, TotalIvaGNC, TotalIvaNoInscriptoGNC, TotalCDGNC, TotalIIBBGNC,TotalIIBBGNCCABA, TotalTotalGNC );
...
begin
    try
        ...
        TotalIIBBVTVCABA := ConviertePuntoEnComa(TotalIIBBVTVCABA);
        ...
        TotalIIBBGNCCABA := ConviertePuntoEnComa(TotalIIBBGNCCABA);
        ...
        EdtIIBBvtvCABA.Text := TotalIIBBVTVCABA;
        ...
        EdtIIBBgncCABA.Text := TotalIIBBgncCABA;
        ...
        EdtTotalIIBBCABA.text := floattostrf(strtofloat(TotalIIBBVTVCABA)+strtofloat(TotalIIBBgncCABA),fffixed,8,2);
...
begin
    ...
    try
       ...
       TotalImporteGNC, TotalIvaGNC, TotalIvaNoInscriptoGNC, TotalCDGNC, NumeroFacturasGNC, NumeroNotasCreditoGNC, TotalIIBBVTV,TotalIIBBVTVCABA, TotalTotalVTV, TotalIIBBGNC,TotalIIBBGNCCABA, TotalTotalGNC);
    finally
       Free;
    end;
end;
...
begin
    try
        ...
        try
            ...
            TotalImporteGNC := '0'; TotalIvaGNC := '0';  TotalIvaNoInscriptoGNC := '0';
            TotalCDGNC := '0'; NumeroFacturasGNC := '0'; NumeroNotasCreditoGNC := '0';
            TotalIIBBVTV := '0'; TotalIIBBVTVCABA := '0'; TotalTotalVTV := '0'; TotalIIBBGNC := '0'; TotalTotalGNC := '0';
