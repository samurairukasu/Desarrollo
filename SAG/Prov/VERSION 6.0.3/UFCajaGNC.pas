...
begin
   ...
   if (ainspeccion.ValueByName[FIELD_TIPO]= T_REVERIFICACION) or (ainspeccion.ValueByName[FIELD_TIPO]=T_VOLUNTARIAREVERIFICACION)
      then
          ...
          tipover:='V';
   l3extra:='Nro: '+tipover+Trim(Copy(ainspeccion.ValueByName[FIELD_EJERCICI],3,2))+'000'+fvarios.ValueByName[FIELD_ZONA]+'000'+fvarios.ValueByName[FIELD_ESTACION]+formatoceros(strtoint(ainspeccion.ValueByName[FIELD_CODINSPGNC]),7); //AGRE VAZ
