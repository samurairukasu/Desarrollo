...
begin
  ...
  begin
    ...
    fsql.add('substr(NombreYApellidos(CODCLPRO),1,110) nombre, NROCUPON, F.CODFACTU, substr(Devuelve_Patente(CODINSPE, EJERCICI),1,Formato_codinspe(CODINSPE)) PATENTE, ');
