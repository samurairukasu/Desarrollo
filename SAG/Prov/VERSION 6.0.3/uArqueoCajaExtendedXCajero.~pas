...
type
  ...
  procedure DoArqueoCajaXCajero(const FI,FF,sTipoArqueo: string;
                         var sTotFact, sTotNC, sTotImp, sTotIVAIns, sTotIVANoIns, sTotTot, sTotIIBB,sTotIIBBCABA: string; sTipoCliente:string);
...
begin
    ...
    try
        ...
        sTotIIBBCABA := floattostrf(strtofloat(ParamByName('IIBBCABAEnCaja').AsString),fffixed,8,2);
        Close;
    finally
        Free
    end
       ...
       sTipo_Auxi := TIPO_ARQUEO_AMBOS;
        ...
        try
            try
                ...
                Total := '0'; NumeroFacturas := '0'; NumeroNotasCredito := '0'; TotalIIBB := '0'; TotalIIBBCABA := '0';
...
{                if (sTipo_auxi = TIPO_ARQUEO_TARJETA) and (aTipoCliente <> '') then
                begin
                  ...
                  DoArqueoCajaXCajero(DateIni, DateFin, TipoPago, NumeroFacturas, NumeroNotasCredito, TotalImporte, TotalIva, TotalIvaNoInscripto, Total, TotalIIBB, TotalIIBBCABA,aTipoCliente);
...
begin
    try
        ...
        TotalIIBB := ConviertePuntoEnComa(TotalIIBB);
         TotalIIBBCABA := ConviertePuntoEnComa(TotalIIBBCABA);
        ...
        edtTotalIIBBCABA.Text := TotalIIBBCABA;
        ...
        begin
            ...
            CommandText := 'SELECT PTOVENTA, NUMFACTURA, TIPOCLIENTE, TO_CHAR(FECHALTA,''YYYY/DD/MM'') FO, ' +
                           ...
                           'TOTAL, CONCEPTO, IIBB,IIBB_CABA FROM TTMPARQCAJAEXTEN ORDER BY FO, TIPOFACTURA, PTOVENTA, NUMFACTURA ';
            {$IFDEF TRAZAS}
            ...
            case Imprimir of
                ...
                begin
                    ...
                    try
                       ...
                       Execute(DateIni, DateFin, TotalImporte, TotalIva, TotalIvaNoInscripto, Total, NumeroFacturas, NumeroNotasCredito, PutTipoPago(TipoPago), NombreEstacion, NumeroEstacion, aTipoCliente, TotalIIBB,TotalIIBBCABA);
                    finally
                        Free;
                    end;
                end;
       ...
       then begin
            case ExportarAscii of
                ...
                begin
                    with TFArqueoCajaExtendedToPrintxCajero.Create(Application) do
                    try
                        ExportaAscii(DateIni, DateFin, TotalImporte, TotalIva, TotalIvaNoInscripto, Total, NumeroFacturas, NumeroNotasCredito, PutTipoPago(TipoPago), NombreEstacion, NumeroEstacion, aTipoCliente, TotalIIBB,TotalIIBBCABA);
                    finally
                        Free;
                    end;
                end;
