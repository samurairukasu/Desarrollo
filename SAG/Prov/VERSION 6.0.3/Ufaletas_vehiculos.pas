...
if trim(edit1.Text)='' then
 ...
 try
    sql_global:= TSQLQuery.Create(self);
     ...
     sql_global.SQL.Add('SELECT FECHALTA, codvehic, patenten, idusuario_alta, motivo, fechabaja, idusuario_baja FROM patente_en_alerta WHERE PATENTEN=:PATENTE and fechabaja is null');
