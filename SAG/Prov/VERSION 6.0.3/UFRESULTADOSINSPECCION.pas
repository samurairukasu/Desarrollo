...
// ALTER TABLE TTMPRESINSP MODIFY (FECHALTA VARCHAR2(10));
  ...
  TFResultadosInspeccion = class(TForm)
    ...
    procedure DBReVerificacionesDrawColumnCell(Sender: TObject;
...
procedure TFResultadosInspeccion.DBReVerificacionesDrawColumnCell(
...
//begin
   // El valor de la celda es impar?
    if trim(DBReVerificaciones.Columns[14].Field.asstring)='A'  then begin
      // Cambia el color de fondo de la celda a ROJO.
      DBReVerificaciones.Canvas.Brush.Color := clRed;
      // Manda pintar la celda
      DBReVerificaciones.DefaultDrawColumnCell(rect,DataCol,Column,State);
    end;
///  end;
end;
