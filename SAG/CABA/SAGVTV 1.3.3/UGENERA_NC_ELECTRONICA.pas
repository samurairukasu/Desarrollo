...
if TIENE_CONEXION_ELECTRONICA=true then
   begin
        ...
        showmessage('Próximo Nro para pv 2 tipo A '+inttostr(fa.proxima_nca_2)+#13+
                    'Próximo Nro para pv 2 tipo B '+inttostr(fa.proxima_ncb_2)+#13+
                    'Próximo Nro para pv 3 tipo A '+inttostr(fa.proxima_nca_3)+#13+
                    'Próximo Nro para pv 3 tipo B '+inttostr(fa.proxima_ncb_3));
