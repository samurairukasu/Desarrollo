...
procedure ObtenerLiteralCalificativo (aBD: TSQLConnection; iEjercicio, iCodInspeccion: longint;
...
var
    ...
    parte1,parte2,parte3,valor1,valor2,valor3,auxUbic:string;
begin
              ...
              Try
                  ...
                  begin
                      ...
                      then
                          ...
                          if sCadenaDefecto = '03.10.050' then sDescripcion := format (sLiteral, [StrToPuntoComa(Fields[2].AsString, 2, 0)]) //OK
                          else if sCadenaDefecto = '03.10.051' then //OK
                          ...
                          else if sCadenaDefecto = '04.03.001' then    //OK
                              sDescripcion :=  format (sLiteral,
                                                [StrToPuntoComa(Fields[18].AsString,10,2) ])
                          else if sCadenaDefecto = '04.04.001' then    //OK
                              sDescripcion := format (sLiteral,
                                               [StrToPuntoComa(Fields[27].AsString,2,0),
                                                StrToPuntoComa(Fields[20].AsString,2,0),
                                                StrToPuntoComa(Fields[19].AsString,2,0),
                                                StrToPuntoComa(Fields[22].AsString,2,0),
                                                StrToPuntoComa(Fields[21].AsString,2,0) ])
                                                
                          else if sCadenaDefecto = '04.05.001' then    //OK
                              sDescripcion := format (sLiteral,
                                               [StrToPuntoComa(Fields[36].AsString,3,2),
                                                StrToPuntoComa(Fields[29].AsString,3,2),
                                                StrToPuntoComa(Fields[28].AsString,3,2) ])


                          else if sCadenaDefecto = '04.06.001' then    //OK
                              sDescripcion := format (sLiteral,
                                               [StrToPuntoComa(Fields[37].AsString,3,2),
                                                StrToPuntoComa(Fields[31].AsString,3,2),
                                                StrToPuntoComa(Fields[30].AsString,3,2) ])

                          else if ((sCadenaDefecto = '02.01.005') or (sCadenaDefecto = '02.01.006') or (sCadenaDefecto = '02.01.007'))  and (sUbicacion<>'') then
                          begin
                              if sUbicacion='BI' then auxUbic := ' - LUZ BAJA IZQUIERDA'
                              else if sUbicacion='BD' then auxUbic := ' - LUZ BAJA DERECHA'
                              else if sUbicacion='AI' then auxUbic := ' - LUZ ALTA IZQUIERDA'
                              else if sUbicacion='AD' then auxUbic := ' - LUZ ALTA DERECHA'
                              else  auxUbic:='';
                              sDescripcion := sLiteral+auxUbic;
                          end
                          ...
                          else if sCadenaDefecto = '05.01.001' then
                          ...
                          else if sCadenaDefecto = '05.01.003' then
                              case sUbicacion[1] of
  ...
  *}
                          ...
                          else if sCadenaDefecto = '10.01.001' then    //OK
                              sDescripcion := format (sLiteral,
                          ...
                          else if sCadenaDefecto = '10.01.002' then      //OK
                              sDescripcion :=  format (sLiteral,
                                                [StrToPuntoComa(Fields[67].AsString,10,2),
                                                 StrToPuntoComa(Fields[66].AsString,10,2),
                                                 StrToPuntoComa(Fields[68].AsString,10,2) ])
                          else if sCadenaDefecto = '10.01.004' then    //OK
                              sDescripcion := format (sLiteral,
                                               [StrToPuntoComa(Fields[81].AsString,10,2),
                                                StrToPuntoComa(Fields[82].AsString,10,2),
                                                StrToPuntoComa(Fields[83].AsString,10,2) ])
                          else if sCadenaDefecto = '10.01.005' then      //OK
                              sDescripcion :=  format (sLiteral,
                                                [StrToPuntoComa(Fields[82].AsString,10,2),
                                                 StrToPuntoComa(Fields[81].AsString,10,2),
                                                 StrToPuntoComa(Fields[83].AsString,10,2) ])
 {*
                                 ...
                                 begin
                                      ...
                                      sDescripcion:=parte1+':'+valor1+'  '+parte2+':'+valor2+'  '+parte3+':'+valor3;
                                                           ...
                                                           *}
                          else if sCadenaDefecto = '10.01.003' then    //OK
                              sDescripcion :=  format (sLiteral,
                                                [StrToPuntoComa(Fields[70].AsString,10,2) ])
                          else if sCadenaDefecto = '10.03.001' then    //OK
                              sDescripcion :=  format (sLiteral,
                                                [StrToPuntoComa(Fields[78].AsString,10,2) ])
                          else if sCadenaDefecto = '10.04.002' then    //OK
                              sDescripcion :=  format (sLiteral,
                                                [StrToPuntoComa(Fields[79].AsString,10,2) ])
