...
type
  ...
  tDatos_DatosComunes = record
    ...
    tDatos_HC_MAXIMO_MOTORCICLOTTO = record
    sHC_OK_91_93: string;
    sHC_OBS_91_93: string;
    sHC_LEVEL_91_93: string;
    sHC_OK_92_94: string;
    sHC_OBS_92_94: string;
    sHC_LEVEL_92_94: string;
    sHC_OK_95_99: string;
    sHC_OBS_95_99: string;
    sHC_LEVEL_95_99: string;
    sHC_OK_99_ACT: string;
    sHC_OBS_99_ACT: string;
    sHC_LEVEL_99_ACT: string;
    sHC_OK_2t: string;
    sHC_OBS_2t: string;
    sHC_LEVEL_2t: string;
    sHC_OK_4t: string;
    ...
    tDatos_CO_MAXIMO_MOTORCICLOTTO = record
    sCO_OK_91_93: string;
    sCO_OBS_91_93: string;
    sCO_LEVEL_91_93: string;
    sCO_OK_92_94: string;
    sCO_OBS_92_94: string;
    sCO_LEVEL_92_94: string;
    sCO_OK_95_99: string;
    sCO_OBS_95_99: string;
    sCO_LEVEL_95_99: string;
    sCO_OK_99_ACT: string;
    sCO_OBS_99_ACT: string;
    sCO_LEVEL_99_ACT: string;
    sCO_OK_2t: string;
    sCO_OBS_2t: string;
    sCO_LEVEL_2t: string;
    sCO_OK_4t: string;
  ...
  tDatos_Ruido = record
    srescape1996O: string;
    srescape1996L: string;
    srescape1996G: string;
    srescape1997O: string;
    srescape1997L: string;
    srescape1997G: string;
    srbocinaO: string;
    srbocinaL: string;
    srbocinaG: string;
  end;
  ...
  private
  S:tDatos_CO_MAXIMO_MOTORCICLOTTO;
    ...
    function ValoresRuidos_Validos: boolean;
    function ValoresHc_Validos: boolean;
    function ValoresDatosCOMAXIMO_Validos: boolean;
    ...
    function guardar_valores_co(nrocampo,depende:longint;valor:string):boolean;
    ...
    function ActualizarDatos_Ruido (DRU: tDatos_Ruido): boolean;
    function ActualizarDatos_HC (Ddh: tDatos_HC_MAXIMO_MOTORCICLOTTO): boolean;

    function ActualizarDatos_co_maximo (DMC: tDatos_CO_MAXIMO_MOTORCICLOTTO; SD: tSentidoDComunes): boolean;
    ...
    function RellenarValores_Ruido (var Datos_Ruido: tDatos_Ruido; const ValoresDeCampos: TCampos): boolean;
    function RellenarValores_DatosComunes (var Datos_Com_TCAMPOS: tDatos_DatosComunes; const ValoresDeCampos: TCampos): boolean;

    function RellenarValores_CO_Maximo_motorciclootoo(var Datos_monoxido_TCAMPOS: tDatos_CO_MAXIMO_MOTORCICLOTTO; const ValoresDeCampos: TCampos): boolean;
    function RellenarValores_HC_Maximo_motorciclootoo(var Datos_HC_TCAMPOS: tDatos_HC_MAXIMO_MOTORCICLOTTO; const ValoresDeCampos: TCampos): boolean;
    ...
    function LeerValoresLimite_CO_MAXIMO (var DDC: tDatos_CO_MAXIMO_MOTORCICLOTTO) :boolean;
    function LeerValoresLimite_hc_MAXIMO (var DDH: tDatos_HC_MAXIMO_MOTORCICLOTTO) :boolean;
    function LeerValoresLimite_Ruido (var DRU: tDatos_Ruido) :boolean;

  public
    { Public declarations }
    function ActualizarValoresLimite_TDATINSPECC (DM, DVL, DVP, DR: tDatos_TodosLosVehiculos; DDC: tDatos_DatosComunes;
    DRU: tDatos_Ruido; DDH: tDatos_HC_MAXIMO_MOTORCICLOTTO;SD: tSentido_Vehiculos): boolean;
    ...
    function ActualizarValores_Ruido_TCAMPOS (DRU: tDatos_Ruido): boolean;
    function ActualizarValores_Hc_TCAMPOS (DMH: tDatos_HC_MAXIMO_MOTORCICLOTTO): boolean;
    ...
    function SonIguales_Ruidos (R1, R2: tDatos_Ruido): boolean;
    function SonIguales_Hc (R1, R2: tDatos_HC_MAXIMO_MOTORCICLOTTO): boolean;

    function ActualizarValores_CO_MAXIMO_TCAMPOS (DMC: tDatos_CO_MAXIMO_MOTORCICLOTTO; SDC: tSentidoDComunes): boolean;
    ...
    function LeerValoresLimite_Form (var Datos_Mot_TCAMPOS, Datos_VehiLigeros_TCAMPOS,
                                 ...
                                 var Datos_DCom_TCAMPOS: tDatos_DatosComunes;
                                 var Datos_monoxido_TCAMPOS:tDatos_CO_MAXIMO_MOTORCICLOTTO;
                                 var Datos_Hc_TCAMPOS:tDatos_HC_MAXIMO_MOTORCICLOTTO;
                                 var Datos_Ruido_TCAMPOS:tDatos_Ruido):boolean;
    ...
    procedure RellenarValores_form (Datos_Mot_TCAMPOS, Datos_VehiLigeros_TCAMPOS,
                                 ...
                                 Datos_monoxido_TCAMPOS:tDatos_CO_MAXIMO_MOTORCICLOTTO;
                                 Datos_HC_TCAMPOS:tDatos_hc_MAXIMO_MOTORCICLOTTO;
                                 Datos_Ruido_TCAMPOS:tDatos_Ruido);
  end;
...
const
    ...
    DEPEND_ANT95 = 10;
    DEPEND_POS95= 11;
    DEPEND_ENE93_A_DIC91=12;
    DEPEND_ENE92_A_DIC94=13;
    DEPEND_ENE95_A_DIC99=14;
    DEPEND_ENE99_ACTUAL=15;
    DEPEND_MOTO_MOTOR_2T=16;
    DEPEND_MOTO_MOTOR_4T=17;
    DEPEND_RESCAPE1996 = 18;
    DEPEND_RESCAPE1997 = 19;
    DEPEND_RBOCINA = 20;
    ...
    EFE_OK_CO_MOTOCICLOOTTO = 46;
    EFE_OBS_CO_MOTOCICLOOTTO  = 47;
    EFE_LEVE_CO_MOTOCICLOOTTO  = 48;

    EFE_OK_CO_MOTO2t = 49;
    EFE_OBS_CO_MOTO2t   = 50;
    EFE_LEVE_CO_MOTO2t   = 51;

    EFE_OK_CO_MOTO4t = 49;
    EFE_OBS_CO_MOTO4t   = 50;
    EFE_LEVE_CO_MOTO4t   = 51;

    EFE_OK_HC_MOTOCICLOOTTO = 58;
    EFE_OBS_HC_MOTOCICLOOTTO  = 59;
    EFE_LEVE_HC_MOTOCICLOOTTO  = 60;

    EFE_OK_HC_MOTO2t = 61;
    EFE_OBS_HC_MOTO2t   = 62;
    EFE_LEVE_HC_MOTO2t   = 63;

    EFE_OK_HC_MOTO4t = 61;
    EFE_OBS_HC_MOTO4t   = 62;
    EFE_LEVE_HC_MOTO4t   = 63;
...
resourcestring
    ...
    OBSERV = 'O'; { Observación }
    LEVE = 'L';   { Leve }
    PASA_OK = 'P';{ Pasa (OK) }
    CABECERA_MENSAJES_VALLIM = 'Modificación Valores Límite';

      { Mensajes enviados al usuario desde MTblMaha }
      MSJ_VALLIM_VALNOVALIDO = 'No ha introducido el valor correspondiente o éste es incorrecto';
      MSJ_VALLIM_INC = 'Los valores introducidos en los campos Ok, Observación y/o Defecto Leve no son correctos. Debe introducir dicho trio en orden ascendente o descendente. Si no desea introducir ningún valor introduzca "999999999"';
      ...
      MSJ_UMAIN_ERRBD = 'Ha ocurrido un error grave con la base de datos al intentar obtener los valores límite.';
      MSJ_UMAIN_RESETEAR = 'Atención, los valores límite se han modificado. Para que este cambio tenga efecto ' +
                           'deberá reinicializar los servidores';
      MSJ_UMAIN_ERRACTVALLIM = 'Ha ocurrido un error grave con la base de datos al intentar almacenar los nuevos valores límite.';


procedure Mantenimiento_ValoresLimite (aForm: TForm);
resourcestring
       CABECERA_VALLIM = 'Modificación Valores Límite';
...
var
   ...
   Datos_Ruido: tDatos_Ruido;
   Datos_Hc: tDatos_HC_MAXIMO_MOTORCICLOTTO;
   Sentido_Datos: tSentido_Vehiculos;
   { Tendremos var. auxi que almacenarán valores de la tabla TCAMPOS para que,
...
begin
    ...
    try
       ...
       FTmp.Temporizar(True,True,'Mantenimiento Valores Límite','Iniciando Mantenimiento Valores Límite');
       ...
       try
          ...
          begin
              RellenarValores_form (Datos_Motocicletas_TCAMPOS, Datos_VehiculosLigeros_TCAMPOS,
                                    ...
                                    Datos_DatosComunes_TCAMPOS, ValoresDeCampos,Datos_monoxido_TCAMPOS,Datos_HC_TCAMPOS,Datos_Ruido_TCAMPOS);
              ...
              begin
                  ...
                  try
                     aFTmp.MuestraClock ('Valores Límite','Actualizando los valores límite de los vehículos...');
                     if LeerValoresLimite_Form (Datos_Motocicletas, Datos_VehiculosLigeros,
                           Datos_VehiculosPesados, Datos_Remolques, Datos_DatosComunes,
                           Datos_monoxido_TCAMPOS,Datos_Hc,Datos_Ruido) then
                     begin
                         if (not ((SonIguales_TodosVehiculos (Datos_Motocicletas_TCAMPOS, Datos_Motocicletas))
                              ...
                              and (SonIguales_Ruidos (Datos_Ruido_TCAMPOS, Datos_Ruido))
                              and (SonIguales_Hc (Datos_Hc_TCAMPOS, Datos_Hc))
                         ...
                         begin
                             if (ActualizarValoresLimite_TDATINSPECC (Datos_Motocicletas, Datos_VehiculosLigeros,
                                 Datos_VehiculosPesados,Datos_Remolques,Datos_DatosComunes,Datos_Ruido, Datos_Hc, Sentido_Datos)) then
                             begin
                                 aFTmp.Hide;
...
var
  Sentido: tSentido_Vehiculos; { almacena el sentido de todos los vehículos }
...
function TfrmValoresLimite.guardar_valores_co(nrocampo,depende:longint;valor:string):boolean;
var aq:TsqlQuery;
 sql:string;
begin
      aQ := TsqlQuery.Create(self);
            try
                sql:='update tcampos set umbral='+#39+trim(valor)+#39+', literal='+#39+trim(valor)+#39+' where campo='+inttostr(nrocampo)+' and dependen='+inttostr(depende);
        ...
        if ValoresVehiculosPesados_Validos then
          if ValoresRemolques_Validos then
             if ValoresDatosComunes_Validos then
              if ValoresDatosCOMAXIMO_Validos then
               if ValoresRuidos_Validos then
                if ValoresHc_Validos then
             begin
                 {$IFDEF TRAZAS}
...
// Devuelve True si el valor límite introducido es correcto
...
function TFrmValoresLimite.ValoresRuidos_Validos: boolean;
begin
    Result := False;

    Result := True;

    { Desequilibrio Máximo Amortiguadores Eje }

{*
    if (not ValorLimite_Correcto(edtOkdmae.Text)) then
    begin
        PgCtrlValoresLimite.ActivePage := TSheetRuidos;
        MessageDlg (CABECERA_MENSAJES_VALLIM, MSJ_VALLIM_VALNOVALIDO, mtInformation, [mbYes, mbNo], mbYes,0);
        edtOkdmae.setfocus;
        exit;
    end;
...
function TFrmValoresLimite.ValoresHc_Validos: boolean;
begin
    Result := False;
...
{*
    ...
    // HC ppm Máximos Admisibles Ant. 1992
    ...
    // HC ppm Máximos Admisibles 1992-1994
    ...
    // HC ppm Máximos Admisibles Post. 1994
...
function TFrmValoresLimite.ValoresDatosCOMAXIMO_Validos: boolean;
begin

   
    if not (ValorLimite_Correcto(edit3.Text)) then
    begin

        PgCtrlValoresLimite.ActivePage := TabSheet1;
        MessageDlg (CABECERA_MENSAJES_VALLIM, MSJ_VALLIM_VALNOVALIDO, mtInformation, [mbYes, mbNo], mbYes,0);
        edit3.setfocus;
        exit
    end else
          guardar_valores_co(46,12,trim(edit3.text));



     if not (ValorLimite_Correcto(edit2.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(46,13,trim(edit2.text));


     if not (ValorLimite_Correcto(edit1.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(46,14,trim(edit1.text));


               if not (ValorLimite_Correcto(edit11.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(46,15,trim(edit11.text));
    ...
    if not (ValorLimite_Correcto(edit5.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(47,12,trim(edit5.text));



    if not (ValorLimite_Correcto(edit6.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(47,13,trim(edit6.text));



      if not (ValorLimite_Correcto(edit7.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(47,14,trim(edit7.text));


    if not (ValorLimite_Correcto(edit12.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(47,15,trim(edit12.text));




    if not (ValorLimite_Correcto(edit10.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(48,12,trim(edit10.text));


   if not (ValorLimite_Correcto(edit9.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(48,13,trim(edit9.text));





  if not (ValorLimite_Correcto(edit8.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(48,14,trim(edit8.text));



     if not (ValorLimite_Correcto(edit13.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(48,15,trim(edit13.text));




  if not (ValorLimite_Correcto(edit16.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(49,16,trim(edit16.text));




   if not (ValorLimite_Correcto(edit15.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(50,16,trim(edit15.text));



     if not (ValorLimite_Correcto(edit14.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(51,16,trim(edit14.text));





     if not (ValorLimite_Correcto(edit19.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(49,17,trim(edit19.text));



     
     if not (ValorLimite_Correcto(edit18.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(50,17,trim(edit18.text));




   if not (ValorLimite_Correcto(edit17.Text)) then
    begin
        ...
        exit
          ...
          guardar_valores_co(51,17,trim(edit17.text));

end;

function TFrmValoresLimite.RellenarValores_Ruido (var Datos_Ruido: tDatos_Ruido; const ValoresDeCampos: TCampos): boolean;
begin
   try
      with ValoresDeCampos do
      begin
        rescape1996O.Text := SimboloDeCampoPara (EFE_O_RESCAPE, DEPEND_RESCAPE1996);
        rescape1996L.Text := SimboloDeCampoPara (EFE_L_RESCAPE, DEPEND_RESCAPE1996);
        rescape1996G.Text := SimboloDeCampoPara (EFE_G_RESCAPE, DEPEND_RESCAPE1996);

        rescape1997O.Text := SimboloDeCampoPara (EFE_O_RESCAPE, DEPEND_RESCAPE1997);
        rescape1997L.Text := SimboloDeCampoPara (EFE_L_RESCAPE, DEPEND_RESCAPE1997);
        rescape1997G.Text := SimboloDeCampoPara (EFE_G_RESCAPE, DEPEND_RESCAPE1997);

        rbocinaO.Text := SimboloDeCampoPara (EFE_O_RBOCINA, DEPEND_RBOCINA);
        rbocinaL.Text := SimboloDeCampoPara (EFE_L_RBOCINA, DEPEND_RBOCINA);
        rbocinaG.Text := SimboloDeCampoPara (EFE_G_RBOCINA, DEPEND_RBOCINA);


        { Ahora rellenamos los valores de una var. auxi de MOTOCICLETAS }
        with Datos_Ruido do
        begin
          srescape1996O:=rescape1996O.Text;
          srescape1996L:=rescape1996L.Text;
          srescape1996G:=rescape1996G.Text;

          srescape1997O:=rescape1997O.Text;
          srescape1997L:=rescape1997L.Text;
          srescape1997G:=rescape1997G.Text;

          srbocinaO:=rbocinaO.Text;
          srbocinaL:=rbocinaL.Text;
          srbocinaG:=rbocinaG.Text;
        end;
      end;
      Result := True;
   except
...
function TFrmValoresLimite.RellenarValores_HC_Maximo_motorciclootoo(var Datos_hc_TCAMPOS: tDatos_hc_MAXIMO_MOTORCICLOTTO; const ValoresDeCampos: TCampos): boolean;
begin
   try
      with ValoresDeCampos do
      begin
        hc1991O.Text := SimboloDeCampoPara ( EFE_OK_HC_MOTOCICLOOTTO, DEPEND_ENE93_A_DIC91);
        hc1992O.Text := SimboloDeCampoPara ( EFE_OK_HC_MOTOCICLOOTTO, DEPEND_ENE92_A_DIC94);
        hc1995O.Text := SimboloDeCampoPara ( EFE_OK_HC_MOTOCICLOOTTO, DEPEND_ENE95_A_DIC99);
        hc2000O.Text := SimboloDeCampoPara ( EFE_OK_HC_MOTOCICLOOTTO, DEPEND_ENE99_ACTUAL);


        hc1991L.Text := SimboloDeCampoPara ( EFE_OBS_HC_MOTOCICLOOTTO, DEPEND_ENE93_A_DIC91);
        hc1992L.Text := SimboloDeCampoPara ( EFE_OBS_HC_MOTOCICLOOTTO, DEPEND_ENE92_A_DIC94);
        hc1995L.Text := SimboloDeCampoPara ( EFE_OBS_HC_MOTOCICLOOTTO, DEPEND_ENE95_A_DIC99);
        hc2000L.Text := SimboloDeCampoPara ( EFE_OBS_HC_MOTOCICLOOTTO, DEPEND_ENE99_ACTUAL);


        hc1991G.Text := SimboloDeCampoPara ( EFE_LEVE_HC_MOTOCICLOOTTO  , DEPEND_ENE93_A_DIC91);
        hc1992G.Text := SimboloDeCampoPara ( EFE_LEVE_HC_MOTOCICLOOTTO  , DEPEND_ENE92_A_DIC94);
        hc1995G.Text := SimboloDeCampoPara ( EFE_LEVE_HC_MOTOCICLOOTTO  , DEPEND_ENE95_A_DIC99);
        hc2000G.Text := SimboloDeCampoPara ( EFE_LEVE_HC_MOTOCICLOOTTO, DEPEND_ENE99_ACTUAL);


        hc2TO.Text := SimboloDeCampoPara ( EFE_OK_HC_MOTO2t   , DEPEND_MOTO_MOTOR_2T);
        hc2TL.Text := SimboloDeCampoPara ( EFE_OBS_HC_MOTO2t     , DEPEND_MOTO_MOTOR_2T);
        hc2TG.Text := SimboloDeCampoPara ( EFE_LEVE_HC_MOTO2t     , DEPEND_MOTO_MOTOR_2T);


        hc4TO.Text := SimboloDeCampoPara ( EFE_OK_HC_MOTO4t   , DEPEND_MOTO_MOTOR_4T);
        hc4TL.Text := SimboloDeCampoPara ( EFE_OBS_HC_MOTO4t     , DEPEND_MOTO_MOTOR_4T);
        hc4TG.Text := SimboloDeCampoPara ( EFE_LEVE_HC_MOTO4t     , DEPEND_MOTO_MOTOR_4T);



      end;

      with Datos_hc_TCAMPOS do
      begin
        sHC_OK_91_93:=trim(hc1991O.Text);
        sHC_OBS_91_93:=trim(hc1991L.Text);
        sHC_LEVEL_91_93:=trim(hc1991G.Text);

        sHC_OK_92_94:=trim(hc1992O.Text);
        sHC_OBS_92_94:=trim(hc1992L.Text);
        sHC_LEVEL_92_94:=trim(hc1992G.Text);

        sHC_OK_95_99:=trim(hc1995O.Text);
        sHC_OBS_95_99:=trim(hc1995L.Text);
        sHC_LEVEL_95_99:=trim(hc1995G.Text);

        sHC_OK_99_ACT:=trim(hc2000O.Text);
        sHC_OBS_99_ACT:=trim(hc2000L.Text);
        sHC_LEVEL_99_ACT:=trim(hc2000G.Text);

        sHC_OK_2t:=trim(hc2TO.Text);
        sHC_OBS_2t:=trim(hc2TL.Text);
        sHC_LEVEL_2t:=trim(hc2TG.Text);

        sHC_OK_4t:=trim(hc4TO.Text);
        sHC_OBS_4t:=trim(hc4TL.Text);
        sHC_LEVEL_4t:=trim(hc4TG.Text);
      end;
      Result := True;
   except
        on E:Exception do
...
function TFrmValoresLimite.RellenarValores_CO_Maximo_motorciclootoo(var Datos_monoxido_TCAMPOS: tDatos_CO_MAXIMO_MOTORCICLOTTO; const ValoresDeCampos: TCampos): boolean;
begin
   try
      with ValoresDeCampos do
      begin
        edit3.Text := SimboloDeCampoPara ( EFE_OK_CO_MOTOCICLOOTTO, DEPEND_ENE93_A_DIC91);
        edit2.Text := SimboloDeCampoPara ( EFE_OK_CO_MOTOCICLOOTTO, DEPEND_ENE92_A_DIC94);
        edit1.Text := SimboloDeCampoPara ( EFE_OK_CO_MOTOCICLOOTTO, DEPEND_ENE95_A_DIC99);
        edit11.Text := SimboloDeCampoPara ( EFE_OK_CO_MOTOCICLOOTTO, DEPEND_ENE99_ACTUAL);


         edit5.Text := SimboloDeCampoPara ( EFE_OBS_CO_MOTOCICLOOTTO, DEPEND_ENE93_A_DIC91);
        edit6.Text := SimboloDeCampoPara ( EFE_OBS_CO_MOTOCICLOOTTO, DEPEND_ENE92_A_DIC94);
        edit7.Text := SimboloDeCampoPara ( EFE_OBS_CO_MOTOCICLOOTTO, DEPEND_ENE95_A_DIC99);
        edit12.Text := SimboloDeCampoPara ( EFE_OBS_CO_MOTOCICLOOTTO, DEPEND_ENE99_ACTUAL);


        edit10.Text := SimboloDeCampoPara ( EFE_LEVE_CO_MOTOCICLOOTTO  , DEPEND_ENE93_A_DIC91);
        edit9.Text := SimboloDeCampoPara ( EFE_LEVE_CO_MOTOCICLOOTTO  , DEPEND_ENE92_A_DIC94);
        edit8.Text := SimboloDeCampoPara ( EFE_LEVE_CO_MOTOCICLOOTTO  , DEPEND_ENE95_A_DIC99);
        edit13.Text := SimboloDeCampoPara ( EFE_LEVE_CO_MOTOCICLOOTTO, DEPEND_ENE99_ACTUAL);


        edit16.Text := SimboloDeCampoPara ( EFE_OK_CO_MOTO2t   , DEPEND_MOTO_MOTOR_2T);
        edit15.Text := SimboloDeCampoPara ( EFE_OBS_CO_MOTO2t     , DEPEND_MOTO_MOTOR_2T);
        edit14.Text := SimboloDeCampoPara ( EFE_LEVE_CO_MOTO2t     , DEPEND_MOTO_MOTOR_2T);


        edit19.Text := SimboloDeCampoPara ( EFE_OK_CO_MOTO4t   , DEPEND_MOTO_MOTOR_4T);
        edit18.Text := SimboloDeCampoPara ( EFE_OBS_CO_MOTO4t     , DEPEND_MOTO_MOTOR_4T);
        edit17.Text := SimboloDeCampoPara ( EFE_LEVE_CO_MOTO4t     , DEPEND_MOTO_MOTOR_4T);



      end;

      with Datos_monoxido_TCAMPOS do
      begin
        sCO_OK_91_93:=trim(edit3.Text);
        sCO_OBS_91_93:=trim(edit5.Text);
        sCO_LEVEL_91_93:=trim(edit10.Text);

        sCO_OK_92_94:=trim(edit2.Text);
        sCO_OBS_92_94:=trim(edit6.Text);
        sCO_LEVEL_92_94:=trim(edit9.Text);

        sCO_OK_95_99:=trim(edit1.Text);
        sCO_OBS_95_99:=trim(edit7.Text);
        sCO_LEVEL_95_99:=trim(edit8.Text);

        sCO_OK_99_ACT:=trim(edit11.Text);
        sCO_OBS_99_ACT:=trim(edit12.Text);
        sCO_LEVEL_99_ACT:=trim(edit13.Text);

        sCO_OK_2t:=trim(edit16.Text);
        sCO_OBS_2t:=trim(edit15.Text);
        sCO_LEVEL_2t:=trim(edit14.Text);

        sCO_OK_4t:=trim(edit19.Text);
        sCO_OBS_4t:=trim(edit18.Text);
        sCO_LEVEL_4t:=trim(edit17.Text);
      end;
      Result := True;
   except
        on E:Exception do
...
// Devuelve True si se han logrado actualizar TODOS los valores relacionados con los vehículos ligeros en la tabla TCAMPOS
...
// Devuelve True si se han logrado actualizar TODOS los valores relacionados con los vehículos pesados en la tabla TCAMPOS
...
function TfrmValoresLimite.ActualizarValores_RUIDO_TCAMPOS (DRU: tDatos_RUIDO): boolean;
var
  Umbral_Auxi: string; { Almacena el umbral de una tupla }
...
begin
    ...
    begin
        try
           Umbral_Auxi := ConvierteComaEnPunto(sRESCAPE1996O);
           if not (ActualizarCampo_TCAMPOS (EFE_O_RESCAPE, DEPEND_RESCAPE1996, Umbral_Auxi, sRESCAPE1996O, '')) then
              exit;
           Umbral_Auxi := ConvierteComaEnPunto(sRESCAPE1996L);
           if not (ActualizarCampo_TCAMPOS (EFE_L_RESCAPE, DEPEND_RESCAPE1996, Umbral_Auxi, sRESCAPE1996L, '')) then
              exit;
           Umbral_Auxi := ConvierteComaEnPunto(sRESCAPE1996G);
           if not (ActualizarCampo_TCAMPOS (EFE_G_RESCAPE, DEPEND_RESCAPE1996, Umbral_Auxi, sRESCAPE1996G, '')) then
              exit;
           Umbral_Auxi := ConvierteComaEnPunto(sRESCAPE1997O);
           if not (ActualizarCampo_TCAMPOS (EFE_O_RESCAPE, DEPEND_RESCAPE1997, Umbral_Auxi, sRESCAPE1997O, '')) then
              exit;
           Umbral_Auxi := ConvierteComaEnPunto(sRESCAPE1997L);
           if not (ActualizarCampo_TCAMPOS (EFE_L_RESCAPE, DEPEND_RESCAPE1997, Umbral_Auxi, sRESCAPE1997L, '')) then
              exit;
           Umbral_Auxi := ConvierteComaEnPunto(sRESCAPE1997G);
           if not (ActualizarCampo_TCAMPOS (EFE_G_RESCAPE, DEPEND_RESCAPE1997, Umbral_Auxi, sRESCAPE1997G, '')) then
              exit;

           Umbral_Auxi := ConvierteComaEnPunto(sRBOCINAO);
           if not (ActualizarCampo_TCAMPOS (EFE_O_RBOCINA, DEPEND_RBOCINA, Umbral_Auxi, sRBOCINAO, '')) then
              exit;
           Umbral_Auxi := ConvierteComaEnPunto(sRBOCINAL);
           if not (ActualizarCampo_TCAMPOS (EFE_L_RBOCINA, DEPEND_RBOCINA, Umbral_Auxi, sRBOCINAL, '')) then
              exit;
           Umbral_Auxi := ConvierteComaEnPunto(sRBOCINAG);
           if not (ActualizarCampo_TCAMPOS (EFE_G_RBOCINA, DEPEND_RBOCINA, Umbral_Auxi, sRBOCINAG, '')) then
              exit;
...
function TfrmValoresLimite.ActualizarValores_CO_MAXIMO_TCAMPOS (DMC: tDatos_CO_MAXIMO_MOTORCICLOTTO; SDC: tSentidoDComunes): boolean;
var
  Umbral_Auxi: string; { Almacena el umbral de una tupla }
...
begin
    ...
    begin
        ...
        try
           ...
           Umbral_Auxi := ConvierteComaEnPunto(sCO_OK_91_93);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_CO_MOTOCICLOOTTO, DEPEND_ENE93_A_DIC91, Umbral_Auxi, sCO_OK_91_93, dmc.sCO_OK_91_93)) then
              exit;

               Umbral_Auxi := ConvierteComaEnPunto(sCO_OBS_91_93);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_CO_MOTOCICLOOTTO , DEPEND_ENE93_A_DIC91, Umbral_Auxi, sCO_OBS_91_93, dmc.sCO_OBS_91_93)) then
              exit;



                   Umbral_Auxi := ConvierteComaEnPunto(sCO_LEVEL_91_93);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_CO_MOTOCICLOOTTO   , DEPEND_ENE93_A_DIC91, Umbral_Auxi, sCO_LEVEL_91_93, dmc.sCO_LEVEL_91_93)) then
              exit;
                ...
                Umbral_Auxi := ConvierteComaEnPunto(sCO_OK_92_94);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_CO_MOTOCICLOOTTO, DEPEND_ENE92_A_DIC94, Umbral_Auxi, sCO_OK_92_94, dmc.sCO_OK_92_94)) then
              exit;

               Umbral_Auxi := ConvierteComaEnPunto(sCO_OBS_92_94);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_CO_MOTOCICLOOTTO , DEPEND_ENE92_A_DIC94, Umbral_Auxi, sCO_OBS_92_94, dmc.sCO_OBS_92_94)) then
              exit;



                   Umbral_Auxi := ConvierteComaEnPunto(sCO_LEVEL_92_94);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_CO_MOTOCICLOOTTO   , DEPEND_ENE92_A_DIC94, Umbral_Auxi, sCO_LEVEL_92_94, dmc.sCO_LEVEL_92_94)) then
              exit;
                  ...
                  Umbral_Auxi := ConvierteComaEnPunto(sCO_OK_95_99);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_CO_MOTOCICLOOTTO, DEPEND_ENE95_A_DIC99, Umbral_Auxi, sCO_OK_95_99, dmc.sCO_OK_95_99)) then
              exit;

               Umbral_Auxi := ConvierteComaEnPunto(sCO_OBS_95_99);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_CO_MOTOCICLOOTTO , DEPEND_ENE95_A_DIC99, Umbral_Auxi, sCO_OBS_95_99, dmc.sCO_OBS_95_99)) then
              exit;



                   Umbral_Auxi := ConvierteComaEnPunto(sCO_LEVEL_95_99);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_CO_MOTOCICLOOTTO   , DEPEND_ENE95_A_DIC99, Umbral_Auxi, sCO_LEVEL_95_99, dmc.sCO_LEVEL_95_99)) then
              exit;
                  ...
                  Umbral_Auxi := ConvierteComaEnPunto(sCO_OK_99_ACT);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_CO_MOTOCICLOOTTO, DEPEND_ENE99_ACTUAL, Umbral_Auxi, sCO_OK_99_ACT, dmc.sCO_OK_99_ACT)) then
              exit;

               Umbral_Auxi := ConvierteComaEnPunto(sCO_OBS_99_ACT);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_CO_MOTOCICLOOTTO , DEPEND_ENE99_ACTUAL, Umbral_Auxi, sCO_OBS_99_ACT, dmc.sCO_OBS_99_ACT)) then
              exit;



                   Umbral_Auxi := ConvierteComaEnPunto(sCO_LEVEL_99_ACT);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_CO_MOTOCICLOOTTO   , DEPEND_ENE99_ACTUAL, Umbral_Auxi, sCO_LEVEL_99_ACT, dmc.sCO_LEVEL_99_ACT)) then
              exit;
                  ...
                  Umbral_Auxi := ConvierteComaEnPunto(sCO_OK_2t);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_CO_MOTO2t , DEPEND_MOTO_MOTOR_2T, Umbral_Auxi, sCO_OK_2t, dmc.sCO_OK_2t)) then
              exit;

               Umbral_Auxi := ConvierteComaEnPunto(sCO_OBS_2t);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_CO_MOTO2t  , DEPEND_MOTO_MOTOR_2T, Umbral_Auxi, sCO_OBS_2t, dmc.sCO_OBS_2t)) then
              exit;



                   Umbral_Auxi := ConvierteComaEnPunto(sCO_LEVEL_2t);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_CO_MOTO2t   , DEPEND_MOTO_MOTOR_2T, Umbral_Auxi, sCO_LEVEL_2t, dmc.sCO_LEVEL_2t)) then
              exit;
                ...
                Umbral_Auxi := ConvierteComaEnPunto(sCO_OK_4t);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_CO_MOTO4t  , DEPEND_MOTO_MOTOR_4t, Umbral_Auxi, sCO_OK_4t, dmc.sCO_OK_4t)) then
              exit;

               Umbral_Auxi := ConvierteComaEnPunto(sCO_OBS_4t);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_CO_MOTO4t     , DEPEND_MOTO_MOTOR_4t, Umbral_Auxi, sCO_OBS_4t, dmc.sCO_OBS_4t)) then
              exit;



                   Umbral_Auxi := ConvierteComaEnPunto(sCO_LEVEL_4t);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_CO_MOTO4t      , DEPEND_MOTO_MOTOR_4t, Umbral_Auxi, sCO_LEVEL_4t, dmc.sCO_LEVEL_4t)) then
              exit;
...
function TfrmValoresLimite.ActualizarValores_HC_TCAMPOS (DMH: tDatos_HC_MAXIMO_MOTORCICLOTTO): boolean;
var
  Umbral_Auxi: string; { Almacena el umbral de una tupla }
...
begin
    ...
    begin
        ...
        try
           ...
           Umbral_Auxi := ConvierteComaEnPunto(sHC_OK_91_93);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_HC_MOTOCICLOOTTO, DEPEND_ENE93_A_DIC91, Umbral_Auxi, sHC_OK_91_93, '')) then
              exit;
                Umbral_Auxi := ConvierteComaEnPunto(sHC_OBS_91_93);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_HC_MOTOCICLOOTTO , DEPEND_ENE93_A_DIC91, Umbral_Auxi, sHC_OBS_91_93, '')) then
              exit;
                   Umbral_Auxi := ConvierteComaEnPunto(sHC_LEVEL_91_93);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_HC_MOTOCICLOOTTO   , DEPEND_ENE93_A_DIC91, Umbral_Auxi, sHC_LEVEL_91_93, '')) then
              exit;
                Umbral_Auxi := ConvierteComaEnPunto(sHC_OK_92_94);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_HC_MOTOCICLOOTTO, DEPEND_ENE92_A_DIC94, Umbral_Auxi, sHC_OK_92_94, '')) then
              exit;
               Umbral_Auxi := ConvierteComaEnPunto(sHC_OBS_92_94);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_HC_MOTOCICLOOTTO , DEPEND_ENE92_A_DIC94, Umbral_Auxi, sHC_OBS_92_94, '')) then
              exit;
                   Umbral_Auxi := ConvierteComaEnPunto(sHC_LEVEL_92_94);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_HC_MOTOCICLOOTTO   , DEPEND_ENE92_A_DIC94, Umbral_Auxi, sHC_LEVEL_92_94, '')) then
              exit;
                  Umbral_Auxi := ConvierteComaEnPunto(sHC_OK_95_99);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_HC_MOTOCICLOOTTO, DEPEND_ENE95_A_DIC99, Umbral_Auxi, sHC_OK_95_99, '')) then
              exit;
               Umbral_Auxi := ConvierteComaEnPunto(sHC_OBS_95_99);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_HC_MOTOCICLOOTTO , DEPEND_ENE95_A_DIC99, Umbral_Auxi, sHC_OBS_95_99, '')) then
              exit;
                   Umbral_Auxi := ConvierteComaEnPunto(sHC_LEVEL_95_99);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_HC_MOTOCICLOOTTO   , DEPEND_ENE95_A_DIC99, Umbral_Auxi, sHC_LEVEL_95_99, '')) then
              exit;
                  Umbral_Auxi := ConvierteComaEnPunto(sHC_OK_99_ACT);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_HC_MOTOCICLOOTTO, DEPEND_ENE99_ACTUAL, Umbral_Auxi, sHC_OK_99_ACT, '')) then
              exit;
               Umbral_Auxi := ConvierteComaEnPunto(sHC_OBS_99_ACT);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_HC_MOTOCICLOOTTO , DEPEND_ENE99_ACTUAL, Umbral_Auxi, sHC_OBS_99_ACT, '')) then
              exit;
                   Umbral_Auxi := ConvierteComaEnPunto(sHC_LEVEL_99_ACT);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_HC_MOTOCICLOOTTO   , DEPEND_ENE99_ACTUAL, Umbral_Auxi, sHC_LEVEL_99_ACT, '')) then
              exit;
                  Umbral_Auxi := ConvierteComaEnPunto(sHC_OK_2t);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_HC_MOTO2t , DEPEND_MOTO_MOTOR_2T, Umbral_Auxi, sHC_OK_2t, '')) then
              exit;
              Umbral_Auxi := ConvierteComaEnPunto(sHC_OBS_2t);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_HC_MOTO2t  , DEPEND_MOTO_MOTOR_2T, Umbral_Auxi, sHC_OBS_2t, '')) then
              exit;
                   Umbral_Auxi := ConvierteComaEnPunto(sHC_LEVEL_2t);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_HC_MOTO2t   , DEPEND_MOTO_MOTOR_2T, Umbral_Auxi, sHC_LEVEL_2t, '')) then
              exit;
                Umbral_Auxi := ConvierteComaEnPunto(sHC_OK_4t);
           if not (ActualizarCampo_TCAMPOS ( EFE_OK_HC_MOTO4t  , DEPEND_MOTO_MOTOR_4t, Umbral_Auxi, sHC_OK_4t, '')) then
              exit;
               Umbral_Auxi := ConvierteComaEnPunto(sHC_OBS_4t);
           if not (ActualizarCampo_TCAMPOS ( EFE_OBS_HC_MOTO4t     , DEPEND_MOTO_MOTOR_4t, Umbral_Auxi, sHC_OBS_4t, '')) then
              exit;
                   Umbral_Auxi := ConvierteComaEnPunto(sHC_LEVEL_4t);
           if not (ActualizarCampo_TCAMPOS (EFE_LEVE_HC_MOTO4t      , DEPEND_MOTO_MOTOR_4t, Umbral_Auxi, sHC_LEVEL_4t, '')) then
              exit;
...
//Devuelve True si ha leído correctamente todos los valores del form. Devuelve los valores límite de una Motocicleta
...
// Devuelve los valores límite de un Vehículo Ligero. Devuelve True si ha logrado leer correctamente todos los valores del form
...
// Devuelve los valores límite de un Vehículo Pesado. Devuelve True si ha logrado leer todos los valores del form correctamente
...
// Devuelve los valores límite de un Remolque. Devuelve true si ha logrado leer correctamente todos los valores del form
...
function TFrmValoresLimite.LeerValoresLimite_CO_MAXIMO (var DDC: tDatos_CO_MAXIMO_MOTORCICLOTTO) :boolean;
begin
    try
       with DDC do
       begin
...
function TFrmValoresLimite.LeerValoresLimite_HC_MAXIMO (var DDH: tDatos_HC_MAXIMO_MOTORCICLOTTO) :boolean;
begin
    try
       with DDH do
       begin

       sHC_OK_91_93:=TRIM(EDIT3.TEXT);
       sHC_OBS_91_93:=TRIM(EDIT5.TEXT);
       sHC_LEVEL_91_93:=TRIM(EDIT10.TEXT);
       sHC_OK_92_94:=TRIM(EDIT2.TEXT);
       sHC_OBS_92_94:=TRIM(EDIT6.TEXT);
       sHC_LEVEL_92_94:=TRIM(EDIT9.TEXT);
       sHC_OK_95_99:=TRIM(EDIT1.TEXT);
       sHC_OBS_95_99:=TRIM(EDIT7.TEXT);
       sHC_LEVEL_95_99:=TRIM(EDIT8.TEXT);
       sHC_OK_99_ACT:=TRIM(EDIT11.TEXT);
       sHC_OBS_99_ACT:=TRIM(EDIT12.TEXT);
       sHC_LEVEL_99_ACT:=TRIM(EDIT13.TEXT);
       sHC_OK_2t:=TRIM(EDIT16.TEXT);
       sHC_OBS_2t:=TRIM(EDIT15.TEXT);
       sHC_LEVEL_2t:=TRIM(EDIT14.TEXT);
       sHC_OK_4t:=TRIM(EDIT19.TEXT);
       sHC_OBS_4t:=TRIM(EDIT18.TEXT);
       sHC_LEVEL_4t:=TRIM(EDIT17.TEXT);
       end;
       Result := True
    except
        on E:Exception do
...
function TFrmValoresLimite.LeerValoresLimite_Ruido (var DRU: tDatos_Ruido) :boolean;
begin
    try
       with DRU do
       begin
...
{ Hay que inicializarlos a CADENA_VACIA y antes de actualizar el campo SENTIDO
  de TCAMPOS hay que ver si está vacío para no actualizarlo. Esto hay que hacerlo
  por si el usuario NO cambia un trío de valores }
...
// Devuelve True si los dos registros pasados por parámetro tienen sus valores iguales
...
// Devuelve True si los dos registros pasados por parámetro tienen sus valores iguales
function TfrmValoresLimite.SonIguales_Ruidos (R1, R2: tDatos_Ruido): boolean;
begin
    Result := ((R1.srescape1996O = R2.srescape1996O) and
               (R1.srescape1996L = R2.srescape1996L) and
               (R1.srescape1996G = R2.srescape1996G) and
               (R1.srescape1997O = R2.srescape1997O) and
               (R1.srescape1997L = R2.srescape1997L) and
               (R1.srescape1997G = R2.srescape1997G) and
               (R1.srbocinaO = R2.srbocinaO) and
               (R1.srbocinaL = R2.srbocinaL) and
               (R1.srbocinaG = R2.srbocinaG));
end;

function TfrmValoresLimite.SonIguales_Hc (R1, R2: tDatos_HC_MAXIMO_MOTORCICLOTTO): boolean;
begin
    Result := (
       (R1.sHC_OK_91_93  =  R2.sHC_OK_91_93) and
       (R1.sHC_OBS_91_93 = R2.sHC_OBS_91_93 ) and
       (R1.sHC_LEVEL_91_93 = R2.sHC_LEVEL_91_93   ) and
       (R1.sHC_OK_92_94      =  R2.sHC_OK_92_94 ) and
       (R1.sHC_OBS_92_94  =  R2.sHC_OBS_92_94  ) and
       (R1.sHC_LEVEL_92_94 =  R2.sHC_LEVEL_92_94 ) and
       (R1.sHC_OK_95_99     =  R2.sHC_OK_95_99 ) and
       (R1.sHC_OBS_95_99     = R2.sHC_OBS_95_99 ) and
       (R1.sHC_LEVEL_95_99    = R2.sHC_LEVEL_95_99 ) and
       (R1.sHC_OK_99_ACT       = R2.sHC_OK_99_ACT ) and
       (R1.sHC_OBS_99_ACT     = R2.sHC_OBS_99_ACT ) and
       (R1.sHC_LEVEL_99_ACT   = R2.sHC_LEVEL_99_ACT ) and
       (R1.sHC_OK_2t       =  R2.sHC_OK_2t ) and
       (R1.sHC_OBS_2t       = R2.sHC_OBS_2t ) and
       (R1.sHC_LEVEL_2t      =  R2.sHC_LEVEL_2t) and
       (R1.sHC_OK_4t          =   R2.sHC_OK_4t) and
       (R1.sHC_OBS_4t          =  R2.sHC_OBS_4t) and
       (R1.sHC_LEVEL_4t         =  R2.sHC_LEVEL_4t));
...
begin
    aFTmp := TFTmp.Create (Application);
    try
      aFTmp.MuestraClock('Impresión','Imprimiendo los valores límite de los vehículos');
...
// Devuelve True si se han logrado actualizar los valores límite en TDATINSPECC
function TfrmValoresLimite.ActualizarValoresLimite_TDATINSPECC (DM, DVL, DVP, DR: tDatos_TodosLosVehiculos; DDC: tDatos_DatosComunes; DRU: tDatos_Ruido;DDH: tDatos_HC_MAXIMO_MOTORCICLOTTO; SD: tSentido_Vehiculos): boolean;
var exito:boolean;
begin
    try
        try
           ...
           exito:=FALSE;
           exito:=ActualizarDatos_Ruido(DRU);
           if exito
            then exito:=ActualizarDatos_Motocicletas(DM, SD.Motocicletas);
           if exito
            then exito:=ActualizarDatos_HC(DDH);
           if exito
            then exito:=ActualizarDatos_VehiculosLigeros(DVL, SD.VLigeros);
           if exito
            then exito:=ActualizarDatos_VehiculosPesados(DVP, SD.VPesados);
           if exito
            then exito:=ActualizarDatos_Remolques(DR, SD.Remolques);
           if exito
            then exito:=ActualizarDatos_DatosComunes(DDC, SD.DatosComunes);

           if exito then
           begin
               Result := True;
               {$IFDEF TRAZAS}
                FTrazas.PonAnotacion (TRAZA_FLUJO, 4,FICHERO_ACTUAL,'Se han actualizado correctamente los valores límite en TCAMPOS');
               {$ENDIF}
           end
           else
           begin
               Result := False;
               {$IFDEF TRAZAS}
                FTrazas.PonAnotacion (TRAZA_FLUJO, 5,FICHERO_ACTUAL,'NO se han actualizado correctamente los valores límite en TCAMPOS');
               {$ENDIF}
           end;
        except
             on E:Exception do
             begin
                 Result := False;
                 FAnomalias.PonAnotacion (TRAZA_SIEMPRE,1,FICHERO_ACTUAL,'NO se han actualizado correctamente los valores límite en TCAMPOS: ' + E.Message);
             end;
        end;
    finally
...
// Devuelve True si los datos relativos a los vehículos ligeros se han actualizado correctamente
...
// Devuelve True si los datos relativos a los vehículos pesados se han actualizado correctamente
...
function TfrmValoresLimite.ActualizarDatos_Ruido (DRU: tDatos_Ruido): boolean;
begin
    try
       if ActualizarValores_Ruido_TCAMPOS (DRU) then
       begin
           Result := True;
           {$IFDEF TRAZAS}
             FTrazas.PonAnotacion (TRAZA_FLUJO,15,FICHERO_ACTUAL,'Se han actualizado correctamente los valores de DATOS COMUNES en TCAMPOS');
...
function TfrmValoresLimite.ActualizarDatos_co_maximo(DMC: tDatos_CO_MAXIMO_MOTORCICLOTTO; SD: tSentidoDComunes): boolean;
begin
    try
       if ActualizarValores_CO_MAXIMO_TCAMPOS (Dmc,SD) then
       begin
           Result := True;
           {$IFDEF TRAZAS}
             FTrazas.PonAnotacion (TRAZA_FLUJO,15,FICHERO_ACTUAL,'Se han actualizado correctamente los valores de DATOS COMUNES en TCAMPOS');
...
function TfrmValoresLimite.ActualizarDatos_hc(DDH: tDatos_HC_MAXIMO_MOTORCICLOTTO): boolean;
begin
    try
       if ActualizarValores_HC_TCAMPOS (Ddh) then
       begin
           Result := True;
           {$IFDEF TRAZAS}
             FTrazas.PonAnotacion (TRAZA_FLUJO,15,FICHERO_ACTUAL,'Se han actualizado correctamente los valores de DATOS COMUNES en TCAMPOS');
...
begin
    ...
    RellenarValores_CO_Maximo_motorciclootoo (Datos_monoxido_TCAMPOS, VDeCampos);
    RellenarValores_HC_Maximo_motorciclootoo (Datos_hc_TCAMPOS, VDeCampos);
    RellenarValores_Ruido (Datos_ruido_TCAMPOS, VDeCampos);
...
begin
    Result := (
        ...
        LeerValoresLimite_DatosComunes (Datos_DCom_TCAMPOS) AND
        LeerValoresLimite_CO_MAXIMO (Datos_monoxido_TCAMPOS) AND
        LeerValoresLimite_HC_MAXIMO (Datos_HC_TCAMPOS) AND
        LeerValoresLimite_Ruido (Datos_Ruido_TCAMPOS)
