    ...
    try
      ...
      begin
        ...
        begin
            ...
            begin
                excelHoja.cells[f,C_INI].value := StrToDate(QTTMPIVABOOK.FieldByName('FECHALTA').AsString); //Corrige en la exportacion a excel el formato de fecha entre las fecha 01 al 12 del mes. - Lucas
