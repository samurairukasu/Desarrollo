    ...
    try
      try
         ...
         begin
             ...
             SQLConnection := MyBD;
             Sql.Clear;
             Sql.Add ('SELECT nvl(NUMREVZ1,0) numrevz1, nvl(NUMLINZ1,0) numlinz1, nvl(NUMREVZ2,0) numrevz2, nvl(NUMLINZ2,0) numlinz2, nvl(NUMREVZ3,0)numrevz3, nvl(NUMLINZ3,0) numlinz3 FROM TEMP_DATINSPECC');
