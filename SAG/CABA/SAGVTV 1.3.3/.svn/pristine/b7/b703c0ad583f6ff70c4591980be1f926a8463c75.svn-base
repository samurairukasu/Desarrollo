...
var codinspeA,ejerA,vehicA: string;
begin
    try
       ...
       begin
           ...
           then begin
           codinspeA:=fInspeccion.ValueByName[FIELD_CODINSPE];
           ejerA:=fInspeccion.ValueByName[FIELD_EJERCICI];
           vehicA:=fInspeccion.ValueByName[FIELD_CODVEHIC];
...
begin
          ...
          codfactura:=fInspeccion.ValueByName[FIELD_CODFACTU];
          if codfactura='' then codfactura:='0';
