...
begin
 ...
 if err<>0 then
  ...
  lblnumero.caption:='Nº '+inttostr(strtoint(DriverFiscal1.IF_READ(3)));
...
begin
  ...
  begin
    ...
    tipostatus:='N';
    impfis.Status(Tipostatus);
    lblnumero.caption:='Nº '+inttostr(strtoint(impfis.AnswerField_6));
    accion:='G';
    hora:=#127;
    fecha:=#127;
...
begin
      ...
      begin
        ...
        begin
          showmessage('Cierre Z','No se han realizado movimientos desde el último Cierre de Jornada.'+
