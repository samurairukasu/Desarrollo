        ...
        try
            try
                ...
                begin
                    ...
                    MessageDlg('Generación de Informe.', 'El informe no puede generarse en este instante: ' + E.message + #10 + #13 + 'Espere unos minutos, e intentelo de nuevo', mtError, [mbOk], mbOk, 0)
                end
            end
        finally
            Free;
    ...
    begin
        ...
        try
            ...
            begin
                ...
                MessageDlg('Generación de Informe.', 'El informe no puede generarse en este instante: ' + E.message + #10 + #13 + 'Espere unos minuts, e intentelo de nuevo', mtError, [mbOk], mbOk, 0);
                bErrorCreando := True
            end
        end
    end;
