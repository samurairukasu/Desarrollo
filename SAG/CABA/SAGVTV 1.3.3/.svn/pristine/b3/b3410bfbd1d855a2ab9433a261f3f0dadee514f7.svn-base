object PagosEP: TPagosEP
  ...
  object DSTPagosEP: TDataSource
    DataSet = QTPagosEP
    Left = 169
    Top = 392
  end
  object sdsQTPagosEP: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'SELECT * FROM TTMP_TEPAGO ORDER BY FECHAACREDITACION'
    Params = <>
    Left = 128
    Top = 392
  end
  object dspQTPagosEP: TDataSetProvider
    DataSet = sdsQTPagosEP
    Options = [poIncFieldProps, poAllowCommandText]
    Left = 88
    Top = 392
  end
  object QTPagosEP: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspQTPagosEP'
    Left = 48
    Top = 392
  end
