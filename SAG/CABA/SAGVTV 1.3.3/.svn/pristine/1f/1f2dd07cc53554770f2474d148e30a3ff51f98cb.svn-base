  ...
  with TFrmInformeRevesExternasToPrint.Create(application) do
   try
     ...
     begin
       ...
       SQL.Add('LTRIM(TO_CHAR(MOD(I.EJERCICI,100),''00'')) || '' '' ||  LTRIM(TO_CHAR('''+ InttoStr(fVarios.Zona) +''',''00'')) || LTRIM(TO_CHAR('''+InttoStr(fVarios.CodeEstacion)+''',''00'')) || Formato_codinspe(i.codinspe) INFORME, I.RESULTAD as RESULT2 , TO_CHAR(EX.FECHALTA,''DD/MM/YYYY'')FECHALTA ');
