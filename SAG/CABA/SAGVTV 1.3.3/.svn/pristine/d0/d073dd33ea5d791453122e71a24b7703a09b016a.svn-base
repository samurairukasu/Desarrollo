...
type
  TfmImprimCertAnul = class(TForm)
    ...
    procedure DoImprimeCertAnul(dateini,datefin: String);
  private
    { Private declarations }
  public
    { Public declarations }
  end;
  procedure DoImprimeCertAnul;

var
  fmImprimCertAnul: TfmImprimCertAnul;
...
procedure TfmImprimCertAnul.DoImprimeCertAnul(dateini,datefin: String);
begin
with TfmImprimCertAnul.Create(Application) do
  try
    Query1.Close;
...
procedure TfmImprimCertAnul.FormCreate(Sender: TObject);
begin
  sdsquery1.sqlconnection:=mybd;
end;


procedure TfmImprimCertAnul.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
