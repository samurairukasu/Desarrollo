    ...
    superior:=trim(edit2.Text);
          ...
          try
               ...
               With TSQLQuery.Create(nil) do
                ...
                Application.MessageBox( 'Se ha guardado la configuración correctamente.', 'Atención',
              MB_ICONINFORMATION );
           except
              Application.MessageBox( 'Se produjo un error al intentar guardar la configuración.',
