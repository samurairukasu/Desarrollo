  ...
  public
   tiene_que_imprimir:boolean;
    ...
    procedure Rellenar_NCDescuento(const aPausa:boolean);   //
     ...
     pROCEDURE GENERAR_NC_ELECTRONICA;
...
PROCEDURE TFrmFactura.GENERAR_NC_ELECTRONICA;
VAR sCadena_Auxi,iibb:STRING;
LI:STRING;
LENTRA,tp_factura:STRING;
importe:STRING;
codfactura:LONGINT;
BEGIN
