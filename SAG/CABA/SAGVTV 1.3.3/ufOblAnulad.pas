          ...
          try
            ...
            if RegistrarOblea then
              begin
                Close;
                SQL.Clear;
                SQL.Add('SELECT CODANULAC FROM TOBLEAS_ANULADAS WHERE NUMOBLEA=:OBLEA');
                ParamByName('OBLEA').AsString:=ednumoblea.Text;
                Open;
...
//
                  ...
                  {$IFDEF TRAZAS}
                  FTrazas.PonAnotacion (1,1, FICHERO_ACTUAL, 'SE PASO A ESTADO ANULADO LA OBLEA: '+ednumoblea.Text);
                  {$ENDIF}
//
//**************************************************************************************************
                  ...
                  Close;
                  SQL.Clear;
                  SQL.Add('INSERT INTO TOBLEAS_ANULADAS(CODANULAC,FECHA,NUMOBLEA,MOTIVO,AUTORIZO) ');
                  SQL.Add('VALUES(SQ_TOBLEAS_ANULADAS.nextval,:FECHA,:OBLEA,:MOTIVO,:AUTORIZO)');
