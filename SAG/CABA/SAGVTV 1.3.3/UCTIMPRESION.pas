...
{ LITERALES PARA LOS DISTINTOS ESTADOS POR LOS QUE TRANSCURRE EL TRABAJO }
  ...
  LITERAL_IMPRIMIENDOSE = 'esta imprimiéndose.';
...
{ LITERALES MONSTRADOS EN FORM DE DIALOGO AL USUARIO }
  ...
  LITERAL_CAMBIO_PAPEL_MEDICION = 'Asegurese, antes de continuar, de que el papel adecuado para imprimir INFORMES DE MEDICION se encuentra en la bandeja de impresion';
...
type
  ...
  tTrabajo = ( Nulo, Certificado , Informe, Factura_A, Factura_B, Nota_A, Nota_B, InformeDiferido, NCDescuento_A, NCDescuento_B, Medicion, tAmarilla, InformeGNC, Factura_A_GNC, Factura_B_GNC, Nota_A_GNC, Nota_B_GNC, NO_IMPRIME_REVE);
