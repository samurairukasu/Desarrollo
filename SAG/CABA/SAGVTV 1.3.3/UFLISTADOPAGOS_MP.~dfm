object PagosMP: TPagosMP
  Left = 282
  Top = 122
  Width = 802
  Height = 483
  Caption = 'Pagos Mercado Pago'
  Color = clBtnFace
  ...
  object DBPagosMP: TRxDBGrid
    ...
    Columns = <
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'FECHA ACREDITACION'
        Visible = True
      end
      item
        Alignment = taCenter
  ...
  object SBarPrincipal: TSpeedBar
    ...
    TabOrder = 1
    InternalVer = 1
    object BImportarExcel: TButton
      Left = 134
      Top = 10
      Width = 75
      Height = 25
      Hint = 'Importa Datos desde Excel.'
      Caption = 'Importar'
      TabOrder = 0
      OnClick = BImportarExcelClick
    end
  ...
  object DSTPagosMP: TDataSource
    DataSet = QTPagosMP
    Left = 169
    Top = 392
  end
  object sdsQTPagosMP: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'SELECT * FROM TTMP_TMERCADOPAGO ORDER BY FECHA_ACREDITACION'
    Params = <>
    Left = 128
    Top = 392
  end
  object dspQTPagosMP: TDataSetProvider
    DataSet = sdsQTPagosMP
    Options = [poIncFieldProps, poAllowCommandText]
    Left = 88
    Top = 392
  end
  object QTPagosMP: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspQTPagosMP'
    Left = 48
    Top = 392
  end
end
