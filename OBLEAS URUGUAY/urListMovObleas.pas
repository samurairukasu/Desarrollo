...
type
  TfRepListMovObleas = class(TForm)
  ...
  Procedure DoLisMovObleasGlobal(fi,ff,aTipo: string);
  procedure DoLisMovObleasxPlanta(fi,ff,aPlanta,aTipo: string);

var
  fRepListMovObleas: TfRepListMovObleas;
...
Procedure DoLisMovObleasGlobal(fi,ff,aTipo: string);
begin
  with TfRepListMovObleas.Create(application) do
   try
     with qConsulta do
     begin
...
procedure TfRepListMovObleas.QRBDetalleBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
