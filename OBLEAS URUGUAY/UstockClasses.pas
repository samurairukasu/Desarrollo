...
interface
...

    {
        ...
        public
            constructor CreateByRowId(const aBD: TSQLConnection; const aRowId: string);
            constructor Create (const aBD: TSQLConnection);
            constructor CreateById(const aBD: TSQLConnection; aIdMovimiento : string);
        end;
...
constructor tMovimientos.Create(const aBD: TSQLConnection);
begin
    inherited CreateFromDataBase (aBD,DATOS_MOVIMIENTOS,'');
end;
...
constructor tMovimientos_VTV.Create(const aBD: TSQLConnection);
begin
    inherited CreateFromDataBase (aBD,DATOS_MOVIMIENTOS_VTV,'');
end;

constructor tMovimientos_VTV.CreateById(const aBD: TSQLConnection; aIdMovimiento: string);
begin
    inherited CreateFromDataBase (aBD,DATOS_MOVIMIENTOS_VTV,format('WHERE IDMOVIMIENTO = ''%S''',[aIdMovimiento]));
end;
