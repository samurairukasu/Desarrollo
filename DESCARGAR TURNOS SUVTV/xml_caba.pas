...
function txml_caba.leer_respuesta_informar_verificacion(archivo:string;IDTURNO:LONGINT;men:string):boolean;
  ...
  coEnableBCD = TSQLConnectionOption(102); // boolean
    begin
        ...
        try
            ...
            then// mensaje:='No se encontraron los parámetros de conexión a la base de datos. Verifique el registro de windows.'
           BEGIN
             Application.MessageBox( 'No se encontraron los parámetros de conexión a la base de datos. Verifique el registro de windows.',
  ...
  IDTURNOBUSCAR:=STRTOINT(SELF.ver_turnoID);
   ...
   aq.open;
    ...
    {controla que existea el pago}
       ...
       aqDETALLESPAGO.open;
       while not aqDETALLESPAGO.Eof do
       begin
       ...
       sSql:='INSERT INTO tdatosturno (TURNOID ,'+
                                      ...
                                      'NUMEROCHASISVAL,'+
                                       ...
                                       'values ('+INTTOSTR(IDTURNOBUSCAR)+
                                                  ...
                                                  ','+INTTOSTR(IDESTADOTURNO)+','+#39+TRIM(SELF.ver_estado)+#39+',TO_DATE('+#39+TRIM(ver_fechaNovedad)+#39+',''dd/mm/yyyy hh24:mi:ss''))';
