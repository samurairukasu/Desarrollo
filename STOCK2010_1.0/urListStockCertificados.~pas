...
type
  TfRepListStockCertifInfor = class(TForm)
  ...
  procedure DoLisStockCertificados;

var
  fRepListStockCertifInfor: TfRepListStockCertifInfor;
...
begin
  with TfRepListStockCertifInfor.Create(application) do
   try
