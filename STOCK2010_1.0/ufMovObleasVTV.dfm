object frmMovObleasVTV: TfrmMovObleasVTV
  Left = 247
  Top = 156
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Movimiento de Obleas VTV'
  ClientHeight = 455
  ClientWidth = 456
  Color = clBtnFace
  ...
  object edCantCertif: TDBEdit
    Left = 48
    Top = 335
    Width = 57
    Height = 21
    DataField = 'CANTCERTIF'
    DataSource = srcMovimiento
    TabOrder = 9
    OnEnter = edCantCertifEnter
  end
  object edCantBolsi: TDBEdit
    Left = 328
    Top = 335
    Width = 57
    Height = 21
    ...
    DataSource = srcMovimiento
    TabOrder = 12
    OnEnter = edCantBolsiEnter
  end
  object edCertIni: TDBEdit
    Left = 112
    Top = 336
    Width = 90
    Height = 21
    DataField = 'CERTINICIAL'
    DataSource = srcMovimiento
    MaxLength = 8
    TabOrder = 10
    OnExit = edCertIniExit
  end
  object edCertFin: TDBEdit
    Left = 208
    Top = 336
    Width = 90
    Height = 21
