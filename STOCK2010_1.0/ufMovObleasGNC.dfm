object frmMovObleasGNC: TfrmMovObleasGNC
  Left = 261
  Top = 111
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Movimiento de Obleas GNC'
  ClientHeight = 423
  ClientWidth = 456
  Color = clBtnFace
  ...
  object edCanttarjama: TDBEdit
    Left = 48
    Top = 301
    Width = 57
    Height = 21
    DataField = 'CANTTARJAMA'
    DataSource = srcMovimiento
    TabOrder = 9
    OnEnter = edCanttarjamaEnter
  end
  object edCantetiqgnc: TDBEdit
    Left = 168
    Top = 301
    Width = 57
    Height = 21
    DataField = 'CANTETIQGNC'
    DataSource = srcMovimiento
    TabOrder = 10
    OnEnter = edCantetiqgncEnter
  end
