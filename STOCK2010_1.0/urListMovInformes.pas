...
type
  ...
  Procedure DoLisMovInformes(fi,ff: string);
  procedure DoLisMovInformesPlanta(fi,ff,aPlanta: string);

var
  fRepInformes: TfRepInformes;
...
Procedure DoLisMovInformes(fi,ff: string);
begin
  with TfRepInformes.Create(application) do
   try
    with qConsulta do
     begin
...
procedure TfRepInformes.QRBDetalleBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
