...
type
  TfRepListEntInformes = class(TForm)
  ...
  Procedure DoLisEntInformes(fi,ff: string);
  procedure DoLisEntInformesPlanta(fi,ff,aPlanta: string);

var
  fRepListEntInformes: TfRepListEntInformes;
...
Procedure DoLisEntInformes(fi,ff: string);
begin
  with TfRepListEntInformes.Create(application) do
   try
     with qConsulta do
     begin
...
procedure TfRepListEntInformes.QRBDetalleBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
