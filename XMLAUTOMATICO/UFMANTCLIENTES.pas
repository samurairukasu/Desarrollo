...
begin
    ...
    begin
             ...
             showmessage('ATENCION.', 'Debe seelccionar la provincia.');
    ...
    begin
             ...
             showmessage('ATENCION.', 'Debe seelccionar el codigo postal.');
           CBCodposta.SetFocus;
    ...
    begin
             ...
             showmessage('ATENCION.', 'Debe seelccionar la localidad.');
