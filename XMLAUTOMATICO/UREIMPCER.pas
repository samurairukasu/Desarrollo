...
resourcestring
    CABECERA_MENSAJES_REIMPNC = 'Reimpresión Certificados';
    CABECERA_MENSAJES_REIMPINF = 'Reimpresión I.Inspección';
...
begin
    ...
    try
       ...
       iCodInsp := StrToInt(Copy (edtInformeInspeccion.Text, 12,7));
...
begin
    ...
    begin
        ...
        begin
            if (not (TDominio.TipoDominio (edtMatricula.Text) in [ttdmAntiguo, ttdmAutos, ttdmMotos, ttdmTractor, ttdmEmbajada, ttdmDiplomatica,ttdmMercosur])) then      //mb
            begin
