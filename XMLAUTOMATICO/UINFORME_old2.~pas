...
QRLabel40.Caption:='';
  if Assigned(FInspeccion) then
    ...
    //INSPECCION
     ...
     // LblXVencimiento.Caption := fInspeccion.ValueByName[FIELD_FECVENCI];
      ...
      begin
        ...
        resultado := 'APTO' ;
        QRLabel43.Caption:='APTO PARA CIRCULAR HASTA '+TRIM(FECHA_VENC);
        QRLabel44.Caption:='';
        ...
        BEGIN
           ...
           QRLabel43.Caption:='VALIDO PARA CIRCULAR HASTA '+TRIM(FECHA_VENC);
           QRLabel44.Caption:='REVERIFICACION GRATUITA HASTA '+TRIM(FECHA_VENC);
         END
        else
        if (fInspeccion.ValueByName[FIELD_RESULTAD] = INSPECCION_RECHAZADO) then
           BEGIN
          resultado := 'RECHAZADO';
           QRLabel43.Caption:='NO APTO PARA CIRCULAR';
           QRLabel44.Caption:='REVERIFICACION GRATUITA HASTA '+TRIM(FECHA_VENC);
           END
        else
        BEGIN
    ...
    //  LblXVencimiento.Caption := fConsulta.FieldByName('VENCIMIENTO').AsString;
     ...
     QRLabel41.Caption:=TRIM(resultado);
    ...
    //cambio por los nuevos informes de inspeccion 19/09/2013
 {
    ...
    //para los nuevos informes
     ...
     QRLabel42.Caption:=TRIM(imprimir_tipo_vehiculo);
      //PLANTA
